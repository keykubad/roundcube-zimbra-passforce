...
<body>
  <div class="container">
    ...
    <form id="login-form" method="post" action="islem.php">
      ...
      <div class="form-group">
        <div class="g-recaptcha" data-sitekey="SİTE_KEYİNİ_BURAYA_YAZ"></div>
      </div>
    ...
    <p class="text-center mt-4 text-muted">
      Yeni şifreniz ile 15 dakika sonra erişim sağlayabilirsiniz.
    </p>
  </div>
      ...
      fetch("islem.php", {
        ...
        .then((data) => {
          if (data.success) {
            ...
            setTimeout(() => {
              window.location.href = "https://siteniz.com";
            }, 3000);
          } else {
